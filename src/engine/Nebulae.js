...
export const NEBULAE = [
  {
    ...
    description:
      "A thick crimson dust cloud causing strong static friction and medium drag. Cloaks all ship signatures.",
  ...
  },
  {
    ...
    description:
      "A chilling cryogenic vapor field causing massive engine drag. Dampens shield emissions.",
  ...
  },
  {
    ...
    description:
      "An ultra-dense dark matter fog. Provides extreme stealth capabilities, cutting off visual cues completely.",
    position: { x: 0, y: 1500 },
    radius: 400,
